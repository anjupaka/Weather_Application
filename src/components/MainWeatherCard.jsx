  ...
  const currentDate = timestamp
    ...
    const renderTemperatureIcon = () => {
      if (temperatureCelsius > 23) {
        return <WbSunnyIcon style={{ marginLeft: '20px', fontSize: '3rem', color: 'orange' }} />;
      } else if (temperatureCelsius < 10) {
        return <AcUnitIcon style={{ marginLeft: '20px', fontSize: '3rem', color: 'blue' }} />;
      } else {
        return <CloudIcon style={{ marginLeft: '20px', fontSize: '3rem', color: 'gray' }} />;
      }
    };

    return (
    <div className="glassy-card" style={{ width:'200px', padding:'30px 30px' }}>
